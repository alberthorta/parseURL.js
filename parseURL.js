...
String.prototype.parseURIDomain = function(out_obj) {
	...
	out_obj.user = undefined; out_obj.password = undefined; out_obj.port = undefined; out_obj.domain = undefined;
...
String.prototype.parseURL = function() {
	...
	return (uri_components[4] || "").parseURIDomain({ 
		...
		path     : (uri_components[2] || "").toLowerCase()==='file'?uri_components[5].slice(1):uri_components[5],
